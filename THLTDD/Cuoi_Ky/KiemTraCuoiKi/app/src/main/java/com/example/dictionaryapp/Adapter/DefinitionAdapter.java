...
public class DefinitionAdapter extends RecyclerView.Adapter<DefinitionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DefinitionViewHolder holder, int position) {
        ...
        holder.textView_example.setText("Exemple: " + definitionsList.get(position).getExample());
        ...
        holder.textView_sysnonyms.setText(synonyms);
        holder.textView_antonyms.setText(antonyms);

        holder.textView_sysnonyms.setSelected(true);
